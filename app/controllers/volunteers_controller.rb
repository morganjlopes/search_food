class VolunteersController < ApplicationController
  ...
  # GET /volunteers.json
  def index
    @volunteers = @agency_from_url.volunteers.all
  end
  ...
  # GET /volunteers/new
  def new
    @volunteer = @agency_from_url.volunteers.new
  end
  ...
  def create
    @volunteer = @agency_from_url.volunteers.new(volunteer_params)
  ...
  def update
    respond_to do |format|
      if @volunteer.update(volunteer_params)
        format.html { redirect_to agency_path(@volunteer.agency), notice: 'Volunteer was successfully updated.' }
  ...
  private
    ...
    def volunteer_params
      params.require(:volunteer).permit(:name, :yob, :phone, :email)
    end
end
